                ...
                <div class="filter-container">
                    <div class="filter-content">
                        ...
                        <div class="filter-categories">
                            <?php
                            $query_categorias = "SELECT nome, slug FROM categorias WHERE tipo_id = (SELECT id FROM tipos_parceiros WHERE slug = 'lojas-agropet' LIMIT 1) ORDER BY nome";
        ...
        <div class="container">
            ...
            <div class="parceiros-grid">
                ...
                if ($estado_id && $municipio_id) {
                    $where = ["p.status = 1", "p.municipio_id = ?", "t.slug = 'lojas-agropet'"];
                    $params = [$municipio_id];
                    $types = 'i';
                    ...
                    if ($stmt) {
                        ...
                        if ($res && $res->num_rows > 0) {
                            ...
                            echo '<p style="text-align:center;">Nenhuma loja agropet encontrada neste município.</p>';
                        }
                    }
                } else {
