            ...
            <div class="banner-wrapper">
                ...
                <div class="filter-container">
                    <div class="filter-content">
                        <h2 class="filter-title">Encontre Lojas Agropet</h2>
                        <p class="filter-subtitle">Selecione seu estado, município e categoria para começar</p>
                        <form class="filter-form" method="get" action="lojas-agropet.php">
                        ...
                        <div class="filter-categories">
                            <?php
                            // Buscar categorias do tipo Lojas Agropet
                            $categorias = [];
                            $query_categorias = "SELECT id, nome, slug FROM categorias WHERE tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Lojas Agropet' LIMIT 1) ORDER BY nome";
        ...
        <div class="container">
            ...
            <div class="results-list">
                ...
                if (isset($_GET['categoria']) && $_GET['categoria'] !== '') {
                    ...
                    $where[] = "c.tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Lojas Agropet' LIMIT 1)";
                }
