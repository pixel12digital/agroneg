            ...
            <div class="banner-wrapper">
                ...
                <div class="filter-container">
                    <div class="filter-content">
                        <h2 class="filter-title">Encontre Criadores</h2>
                        <p class="filter-subtitle">Selecione seu estado, município e categoria para começar</p>
                        <form class="filter-form" method="get" action="criadores.php">
                        ...
                        <div class="filter-categories">
                            <?php
                            // Buscar categorias do tipo Criador
                            $categorias = [];
                            $query_categorias = "SELECT id, nome, slug FROM categorias WHERE tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Criador' LIMIT 1) ORDER BY nome";
        ...
        <div class="container">
            ...
            <div class="results-list">
                ...
                if (isset($_GET['categoria']) && $_GET['categoria'] !== '') {
                    ...
                    $where[] = "c.tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Criador' LIMIT 1)";
                }
