...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-Avb2QiuDEEvB4bZJYdft2mNjVRw8VUVZLj2RWEQkGvvBjjGme7+mS7A0nFQGs4TJB0yjL4qcAQBTHhvyw4P5w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                            ...
                            <form class="filter-form" method="GET" action="municipio.php">
                                <div class="filter-row">
                                    ...
                                    <select id="estado" name="estado" class="filter-select" required>
                                        ...
                                        $query = "SELECT DISTINCT e.sigla, e.nome 
                                                 FROM estados e
