            ...
            <div class="banner-wrapper">
                ...
                <div class="filter-container">
                    <div class="filter-content">
                        ...
                        <form class="filter-form" method="get" action="cooperativas.php">
                        ...
                        <div class="filter-categories">
                            <?php
                            // Buscar categorias do tipo Cooperativa
                            $categorias = [];
                            $query_categorias = "SELECT id, nome, slug FROM categorias WHERE tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Cooperativa' LIMIT 1) ORDER BY nome";
        ...
        <div class="container">
            ...
            <div class="results-list">
                ...
                if (isset($_GET['categoria']) && $_GET['categoria'] !== '') {
                    ...
                    $where[] = "c.tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Cooperativa' LIMIT 1)";
                }
                ...
                if ($res && $res->num_rows > 0) {
                    while ($row = $res->fetch_assoc()) {
                        ...
                        echo '<h4><a href="cooperativa-local.php?id=' . $row['id'] . '" class="result-link">' . htmlspecialchars($row['nome']) . '</a></h4>';
