            ...
            <div class="banner-wrapper">
                ...
                <div class="filter-container">
                    <div class="filter-content">
                        ...
                        <form class="filter-form" method="get" action="produtores.php">
                        ...
                        <div class="filter-categories">
                            <?php
                            // Buscar categorias do tipo Produtor
                            $categorias = [];
                            $query_categorias = "SELECT id, nome, slug FROM categorias WHERE tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Produtor' LIMIT 1) ORDER BY nome";
        ...
        <div class="container">
            ...
            <div class="results-list">
                ...
                if (isset($_GET['categoria']) && $_GET['categoria'] !== '') {
                    ...
                    $where[] = "c.tipo_id = (SELECT id FROM tipos_parceiros WHERE nome = 'Produtor' LIMIT 1)";
                }
