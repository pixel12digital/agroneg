...
$instagram_url = get_config($conn, 'instagram_url');
$facebook_url = get_config($conn, 'facebook_url');
$tiktok_url = get_config($conn, 'tiktok_url');
?>
<footer id="site-footer">
    <div class="footer-content">
        <!-- Coluna 1: Logo e Descrição -->
        <div class="footer-col">
            <img src="assets/img/logo-agroneg.png" alt="AgroNeg" class="footer-logo">
